        ...
        items: [
          ...
          },
          {
            ...
            itemTpl: new Ext.XTemplate(
              ...
              "<tpl if='instructor_url !== \"\"'>",
              '<a href="#" onclick="window.open(\'{instructor_url}\', \'_blank\', \'location=yes\')">{instructor_name}&nbsp;',
              '<span style="font-family:\'Pictos\';">A</span></a>',
              '<tpl else>',
              '{instructor_name}&nbsp;',
              '</tpl>',
              '</span></p>',
              "<tpl if='instructor_email !== \"\"'>",
              '<br><p><span style="font-size: 80%;">',
