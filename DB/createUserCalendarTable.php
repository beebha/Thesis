...
$dropQuery = "DROP TABLE IF EXISTS users_calendar";

mysqli_query($link, $dropQuery);

error_log("Dropped TABLE users_calendar");

$createTableSql = "CREATE TABLE users_calendar (
...
error_log("Created TABLE users_calendar");