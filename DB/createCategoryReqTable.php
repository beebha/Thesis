...
$dropQuery = "DROP TABLE IF EXISTS category_req";

mysqli_query($link, $dropQuery);

error_log("Dropped TABLE category_req");

$createTableSql = "CREATE TABLE category_req (
                    concentration_id INT(10) UNSIGNED NOT NULL,
                    category_id INT(10) UNSIGNED NOT NULL,
                    category_count INT(10) UNSIGNED NOT NULL,
...
error_log("Created TABLE category_req");